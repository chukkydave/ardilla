    ...
    return (
        <section className=" bg-[#240053] h-screen flex flex-col  items-center justify-center text-white relative overflow-hidden">
            <div className="text-center lg:pt-[16rem] pt-[10rem] md:w-4/4 w-3/4">
                ...
                <button className="bg-white text-[#240053] hover:text-white hover:bg-[#8807F7] font-cabinet px-10 py-4 rounded-full text-sm">Get Started</button>
            </div>
            <div className="relative  lg:mt-4 md:mt-[5rem] mt-[4rem] flex justify-center items-center">
                <div className="relative z-10 " >
                    ...
                    <img src={pop1} alt="Pop 1" className="absolute md:top-14 top-8 md:right-5 right-5 w-auto md:h-[2.5rem] lg:h-[3.5rem] h-[1.5rem]" />
                </div>
                <div className="relative z-10 lg:-ml-[7em] md:-ml-16 -ml-14 ">
                    ...
                    <img src={pop2} alt="Pop 2" className="absolute md:bottom-[6rem] lg:bottom-[9rem] bottom-[5rem] md:left-6 lg:left-14 left-6 w-auto lg:h-[5.5rem] md:h-[4.5rem] h-[3rem]" />
                </div>
            </div>
        </section>
    );
